...
| Test | Scenario |
|------|----------|
| `shouldReturnBadRequestWithDetail` | IllegalArgumentException -> 400 ProblemDetail (RFC 9457) with detail |
| `shouldReturnInternalServerErrorWithGenericMessage` | RuntimeException -> 500 ProblemDetail with generic message |
