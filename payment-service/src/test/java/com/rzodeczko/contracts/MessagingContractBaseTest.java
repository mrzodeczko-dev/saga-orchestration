...
public abstract class MessagingContractBaseTest {
    ...
    public void payment_reserve_success() throws Exception {
    ...
    public void payment_reserve_failure() throws Exception {
        SagaReplyMessage reply = new SagaReplyMessage(
                SAGA_ID, "PAYMENT", "RESERVE", "FAILURE",
                "Credit limit exceeded"
        );
        sendMessage(reply, "x.saga.replies");
    }

    public void payment_cancel_success() throws Exception {
        SagaReplyMessage reply = new SagaReplyMessage(
